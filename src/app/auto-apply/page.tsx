...
export default function AutoApplyPage() {
  ...
  const { profile, isReadyForAutoApply, completeness, isLoading: profileLoading, profileChecked } = useUserProfile();
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <main className="max-w-[1600px] mx-auto p-4 md:p-6 lg:p-8">
        <AgentControlCenter
          ...
          sessionId={autoApplySessionId || autoApplyProgress?.sessionId} // Fix: Pass session ID
        />
      </main>
    </div>
  );
